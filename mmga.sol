...
contract MMGA {
  ...
  function getComment(uint256 index) public constant returns (address, bytes32, bytes32, int32, uint32, uint256[]) {
  ...
  function getSubComment(uint256 index) public constant returns (bytes32, int32, uint256) {
